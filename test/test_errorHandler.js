...
it("returns 'Un autre gestionnaire de paquet est en cours d'exécution'", function(){
    aptGetErr.errorHandler("11: Ressource temporairement non disponible", function(err){
      expect(err).to.deep.equal("Un autre gestionnaire de paquet est en cours d'exécution");
    })
  })
